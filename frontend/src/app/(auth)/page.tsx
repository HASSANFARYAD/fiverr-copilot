...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-white dark:from-blue-950 dark:to-background p-4">
      <div className="flex items-center gap-2 mb-8">
        ...
        <span className="font-semibold text-lg">Fiverr Copilot</span>
      </div>
      ...
      {step === "landing" && (
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>Sign in to manage your gigs and inbox</CardDescription>
          </CardHeader>
      ...
      {step === "email" && (
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-4">
            ...
            <Button variant="ghost" className="w-full" onClick={() => setStep("landing")}>
              Back to all options
            </Button>
          </CardContent>
        </Card>
